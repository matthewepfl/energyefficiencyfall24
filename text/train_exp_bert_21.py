...
wandb.init(project="energyefficiency", name=f"21_lr-1e-5_dropout-0.3_weightdecay-1e-2_batchsize-32_epochs-50")
...
train(model, train_loader, val_loader, test_loader, criterion, optimizer, scaler, scheduler, device, EPOCHS, save_path="model/text_model_full_cross_val_1_properties21.pth")
...
save_predictions(model, train_loader, device, "train_predictions_properties21.csv")
save_predictions(model, val_loader, device, "val_predictions_properties21.csv")
save_predictions(model, test_loader, device, "test_predictions_properties21.csv")
...
train_predictions_df = pd.read_csv("train_predictions_properties21.csv")
val_predictions_df = pd.read_csv("val_predictions_properties21.csv")
test_predictions_df = pd.read_csv("test_predictions_properties21.csv")
...
final_metrics.to_csv("final_metrics_properties21.csv", index=False)
