...
wandb.init(project="energyefficiency", name=f"exp_bert_all_features_24")
...
# Load property data
properties_train = pd.read_csv(os.path.join(data_path, 'cross_val/train_data_properties24.csv'))['Property Reference Id'].unique().tolist()
properties_val = pd.read_csv(os.path.join(data_path, 'cross_val/val_data_properties24.csv'))['Property Reference Id'].unique().tolist()
properties_test = pd.read_csv(os.path.join(data_path, 'cross_val/test_data_properties24.csv'))['Property Reference Id'].unique().tolist()
...
train(model, train_loader, val_loader, test_loader, criterion, optimizer, scaler, scheduler, device, EPOCHS, save_path="model/text_model_full_all_features_properties24.pth")
...
save_predictions(model, train_loader, device, "/scratch/izar/mmorvan/EnergyEfficiencyPrediction/test/results/train_predictions_all_features_properties24.csv")
save_predictions(model, val_loader, device, "/scratch/izar/mmorvan/EnergyEfficiencyPrediction/test/results/val_predictions_all_features_properties24.csv")
save_predictions(model, test_loader, device, "/scratch/izar/mmorvan/EnergyEfficiencyPrediction/test/results/test_predictions_all_features_properties24.csv")
...
train_predictions_df = pd.read_csv("/scratch/izar/mmorvan/EnergyEfficiencyPrediction/test/results/train_predictions_all_features_properties24.csv")
val_predictions_df = pd.read_csv("/scratch/izar/mmorvan/EnergyEfficiencyPrediction/test/results/val_predictions_all_features_properties24.csv")
test_predictions_df = pd.read_csv("/scratch/izar/mmorvan/EnergyEfficiencyPrediction/test/results/test_predictions_all_features_properties24.csv")
...
final_metrics.to_csv("/scratch/izar/mmorvan/EnergyEfficiencyPrediction/test/results/final_metrics_all_features_properties24.csv", index=False)
