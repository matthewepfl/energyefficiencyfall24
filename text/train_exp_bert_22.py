...
wandb.init(project="energyefficiency", name=f"22_lr-1e-5_dropout-0.3_weightdecay-1e-2_batchsize-32_epochs-50")
...
train(model, train_loader, val_loader, test_loader, criterion, optimizer, scaler, scheduler, device, EPOCHS, save_path="model/text_model_full_cross_val_1_properties22.pth")
...
save_predictions(model, train_loader, device, "train_predictions_properties22.csv")
save_predictions(model, val_loader, device, "val_predictions_properties22.csv")
save_predictions(model, test_loader, device, "test_predictions_properties22.csv")
...
train_predictions_df = pd.read_csv("train_predictions_properties22.csv")
val_predictions_df = pd.read_csv("val_predictions_properties22.csv")
test_predictions_df = pd.read_csv("test_predictions_properties22.csv")
...
final_metrics.to_csv("final_metrics_properties22.csv", index=False)
