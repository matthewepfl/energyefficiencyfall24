...
wandb.init(project="energyefficiency", name=f"exp_bert_all_features")
...
train(model, train_loader, test_loader, criterion, optimizer, scaler, scheduler, device, EPOCHS, save_path="model/text_model_full_all_features_properties21.pth")
...
save_predictions(model, train_loader, device, "train_predictions_all_features_properties21.csv")
save_predictions(model, test_loader, device, "test_predictions_all_features_properties21.csv")
...
train_predictions_df = pd.read_csv("train_predictions_all_features_properties21.csv")
test_predictions_df = pd.read_csv("test_predictions_all_features_properties21.csv")
...
final_metrics = pd.DataFrame({
    ...
    'NMBE': [train_nmbe, test_nmbe]
})

final_metrics.to_csv("final_metrics_all_features_properties21.csv", index=False)
